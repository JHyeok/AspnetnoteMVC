...
#pragma warning disable IDE0022 // Use expression body for methods
        ...
        internal static object OrderByDescending<T>(IQueryable<T> qry, string sortExpression) where T : class {
...
#pragma warning restore IDE0022 // Use expression body for methods
        ...
        public static IQueryable<T> OrderBy<T>(this IQueryable<T> source, string sortExpression) where T : class {
            ...
            foreach (var item in a) {
                // 정렬 위한 수정 OrderBy => OrderByDescending
                var m = index++ > 0 ? "ThenBy" : "OrderByDescending";
                if (item.StartsWith("-")) {
                    m += "Descending";
